...
public class ImageProcessing {
    ...
    twoDToImage(allFilters, "./all_filters_apple.jpg");
    ...
    int[][] generateImg= generateRectangles(randomImg, 100);
	...
	public static int[][] paintRandomImage(int[][] canvas) {
		// TODO: Fill in the code for this method
    // create a new Random object (used to generate random numbers)
    ...
    for (int i=0; i<canvas.length; i++) {
      for (int j=0; j<canvas[i].length; j++) {
        ...
        int alpha= 255;
        int[] rgbaValues= {randRed, randGreen, randBlue, alpha};
